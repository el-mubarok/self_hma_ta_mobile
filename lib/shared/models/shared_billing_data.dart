...
//
//     final sharedBillingData = sharedBillingDataFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

SharedBillingData sharedBillingDataFromJson(String str) =>
    SharedBillingData.fromJson(json.decode(str));

String sharedBillingDataToJson(SharedBillingData data) =>
    json.encode(data.toJson());

class SharedBillingData {
  final int code;
  final Data data;
  ...
  factory SharedBillingData.fromJson(Map<String, dynamic> json) =>
      SharedBillingData(
        code: json["code"],
